...
struct GSaveLand {                                  /* 0x527990 big, align 16 */
  ...
  u8 gap_1e25fc[4];
  GSaveLandMyDesign                  LandMyDesign;                              // @0x1e2600 size 0x4b3a8, align 8
  GSaveEventFlagLand                 EventFlag;                                 // @0x22d9a8 size 0x800, align 2
  GSaveMainField                     MainField;                                 // @0x22e1a8 size 0xdaa2c, align 4
  GSavePlayerHouseList               PlayerHouseList;                           // @0x308bd4 size 0x132000, align 4
  GSaveNpcHouseList                  NpcHouseList;                              // @0x43abd4 size 0x1248, align 4
  GSaveShop                          Shop;                                      // @0x43be1c size 0x33b4, align 4
  GSaveMuseum                        Museum;                                    // @0x43f1d0 size 0x3404, align 4
  GSaveVisitorNpc                    VisitorNpc;                                // @0x4425d4 size 0x78, align 4
  GSaveObjectSnowManFamily           SnowManFamily;                             // @0x44264c size 0x1b8, align 4
  GSaveFg                            Fg;                                        // @0x442804 size 0x928, align 4
  GSaveItemMarketingRoute            ItemMarketingRoute;                        // @0x44312c size 0x2, align 1
  u8 gap_44312e[2];
  GSaveVillageMelody                 VillageMelody;                             // @0x443130 size 0x10, align 8
  GSaveOffice                        Office;                                    // @0x443140 size 0x4, align 4
  u8 gap_443144[4];
  GSaveBulletinBoard                 BulletinBoard;                             // @0x443148 size 0xe0ae8, align 8
  s_b0fdefc8                         RegionLanguage;                            // @0x523c30 size 0x4, align 4
  s_75befa81                         CalendarEventRegion;                       // @0x523c34 size 0x4, align 4
  GSaveCampSite                      CampSite;                                  // @0x523c38 size 0x4, align 4
  GSaveNpcCamp                       NpcCamp;                                   // @0x523c3c size 0x114, align 4
  u8                                 AirportThemeColor;                         // @0x523d50 size 0x1, align 1
  u8 gap_523d51[1];
  GSaveRumorFavorite                 RumorFavorite;                             // @0x523d52 size 0x2520, align 2
  u8 gap_526272[2];
  GSaveMoney                         PublicWorksLoan;                           // @0x526274 size 0x8, align 4
  GSaveItemName                      PublicWorksName;                           // @0x52627c size 0x8, align 4
  GSaveVillageScore                  VillageScore;                              // @0x526284 size 0x250, align 4
  u8 gap_5264d4[4];
  GSaveNetLandProfile                NetLandProfile;                            // @0x5264d8 size 0x58, align 8
  GSaveEventFlagLandTemp             EventFlagTemp;                             // @0x526530 size 0x100, align 2
  GSaveMyDesignFireworks             MyDesignFireworks;                         // @0x526630 size 0x14, align 2
  GSaveSettlerQuest                  SettlerQuest;                              // @0x526644 size 0xc0, align 4
  u8                                 _5d1fcb04[4742];                           // @0x526704 size 0x1, align 1
};
...
struct GSaveMain {                                  /* 0x86d560 big, align 16 */
  GSaveVersion                       Version;                                   // @0x0 size 0x100, align 4
  u8                                 _5d1fcb04[8];                              // @0x100 size 0x1, align 1
  u8 gap_108[8];
  GSaveLand                          Land;                                      // @0x110 size 0x527990, align 16
  GSaveLandOther                     LandOther;                                 // @0x527aa0 size 0x345ac0, align 16
};
