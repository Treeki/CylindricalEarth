...
struct GSaveMovePlayerOption {                      /* 0x71a50 big, align 16 */
  u8 gap_0[256];
  s_7b602b39                         _d35a9251;                                 // @0x100 size 0x10, align 16
  GSavePlayerHouse                   PlayerHouse;                               // @0x110 size 0x26400, align 4
  GSaveLandMyDesign                  LandMyDesign;                              // @0x26510 size 0x4b3a8, align 8
  GSaveMyDesignHolderList            MyDesignHolderList;                        // @0x718b8 size 0xc8, align 1
  GSaveMyDesignListOrder             MyDesignListOrder;                         // @0x71980 size 0xc8, align 1
  s8                                 PreviousVillagerIndex;                     // @0x71a48 size 0x1, align 1
  u8 gap_71a49[1];
  GSaveDate                          _295db8e5;                                 // @0x71a4a size 0x4, align 2
};
...
struct GSavePlayerOther {                           /* 0x2d710 big, align 16 */
  ...
  GSaveNetMailBox                    NetMailBox;                                // @0x23a00 size 0x680, align 8
  GSavePlayerVisitorNpc              VisitorInfo;                               // @0x24080 size 0x90, align 8
  GSaveAudioRegister                 AudioRegister;                             // @0x24110 size 0x20, align 4
  s_79d059af                         RegionLanguageID;                          // @0x24130 size 0x4, align 4
  u8 gap_24134[4];
  GSavePersonalPlayReportInfo        PlayReportInfo;                            // @0x24138 size 0xd10, align 8
  GSaveFishCollection                FishCollection;                            // @0x24e48 size 0xd6, align 2
  GSaveInsectCollection              InsectCollection;                          // @0x24f1e size 0xd6, align 2
  GSaveDiveFishCollection            DiveFishCollection;                        // @0x24ff4 size 0x82, align 2
  u8 gap_25076[2];
  s_2c3a15dc                         ReceivedAoC;                               // @0x25078 size 0x104, align 4
  s_b16331d2                         ReceivedBCAT;                              // @0x2517c size 0x204, align 4
  GSaveMoney                         KabuBuy;                                   // @0x25380 size 0x8, align 4
  GSaveMoney                         KabuSell;                                  // @0x25388 size 0x8, align 4
  GSaveAmiibo                        Amiibo;                                    // @0x25390 size 0xa0, align 4
  GSaveRemakeCommonPattern           RemakeCommonPattern;                       // @0x25430 size 0x10, align 1
  GSaveMoney                         BoxTransfer;                               // @0x25440 size 0x8, align 4
  u32                                _075e237a;                                 // @0x25448 size 0x4, align 4
  GSaveClockTimeList                 ClockTimeList;                             // @0x2544c size 0x180, align 1
  GSaveHashList                      HashList;                                  // @0x255cc size 0x40, align 4
  GSaveEventFlagPlayerTemp           EventFlagPlayerTemp;                       // @0x2560c size 0x200, align 2
  GSaveEventFlagPlayerVisit          EventFlagPlayerVisit;                      // @0x2580c size 0x100, align 2
  nn::util::Uuid                     DeviceId;                                  // @0x2590c size 0x10, align 1
  GSaveMailUserLog                   MailUserLog;                               // @0x2591c size 0x14, align 2
  GSaveDate                          _bbfb1a0c;                                 // @0x25930 size 0x4, align 2
  GSaveMoney                         FoxTotalBuy;                               // @0x25934 size 0x8, align 4
  u8 gap_2593c[4];
  s_e339850a                         FavoriteDesignerList;                      // @0x25940 size 0x6270, align 8
  s_32ab2180                         VisitDreamList;                            // @0x2bbb0 size 0x11f8, align 8
  s_29847e58                         BlockDreamList;                            // @0x2cda8 size 0x320, align 8
  s_a6478d46                         _340be62e;                                 // @0x2d0c8 size 0x644, align 4
};
...
struct GSavePersonal {                              /* 0x64160 big, align 16 */
  ...
  GSavePlayerOther                   PlayerOther;                               // @0x36a50 size 0x2d710, align 16
};
...
struct GSavePhotoStudioHouse {                      /* 0x2c8b8 big, align 4 */
  ...
  GSaveJuneBrideRoomExtra            JuneBrideRoomExtra;                        // @0x2c898 size 0x20, align 4
};
...
struct GSavePhotoStudioIsland {                     /* 0x2c9d0 big, align 16 */
  GSaveVersion                       Version;                                   // @0x0 size 0x100, align 4
  s_7b602b39                         _d35a9251;                                 // @0x100 size 0x10, align 16
  GSavePhotoStudioHouse              PhotoStudioHouse;                          // @0x110 size 0x2c8b8, align 4
};
...
struct GSaveLandOther {                             /* 0x345ac0 big, align 16 */
  GSavePersonal                      GuestPlayers[8];                           // @0x0 size 0x64160, align 16
  s_7b602b39                         _d35a9251;                                 // @0x320b00 size 0x10, align 16
  GSaveFgOther                       Fg;                                        // @0x320b10 size 0x53c, align 4
  u8 gap_32104c[4];
  GSavePostStock                     PostStock;                                 // @0x321050 size 0x1f2e0, align 8
  GSaveShopOther                     ShopOther;                                 // @0x340330 size 0xc, align 4
  u8 gap_34033c[4];
  GSaveLandPlayReportInfo            PlayReportInfo;                            // @0x340340 size 0x480, align 8
  GSaveDebugLog                      DebugLog;                                  // @0x3407c0 size 0x100, align 8
  GSaveLostItemBox                   LostItemBox;                               // @0x3408c0 size 0x280, align 4
  GSaveNetLandID                     NetLandID;                                 // @0x340b40 size 0x80, align 8
  GSavePlayerActivity                CurrentPlayerActivity[8];                  // @0x340bc0 size 0xd8, align 8
  GSavePlayerActivity                PreviousPlayerActivity[8];                 // @0x341280 size 0xd8, align 8
  GSavePlayerActivityPack            VisitorPlayerActivityPack[8];              // @0x341940 size 0x6c0, align 8
  GSaveMyDesignHolderList            MyDesignHolderList;                        // @0x344f40 size 0xc8, align 1
  GSaveLandHashValue                 GrowUpRandomFactor;                        // @0x345008 size 0x4, align 4
  GSaveWeather                       TourWeather;                               // @0x34500c size 0x14c, align 4
  GSaveMyDesignListOrder             MyDesignListOrder;                         // @0x345158 size 0xc8, align 1
  GSaveTime                          LastSaveTime;                              // @0x345220 size 0x8, align 2
  s32                                MoveKitPlayer;                             // @0x345228 size 0x4, align 4
  s32                                MoveKitNpc;                                // @0x34522c size 0x4, align 4
  GSaveHashList                      HashList;                                  // @0x345230 size 0x40, align 4
  GSaveNetworkEventData              EventData;                                 // @0x345270 size 0x280, align 4
  GSaveBackupService                 BackupService;                             // @0x3454f0 size 0x10, align 8
  GSaveDreamLandMeta                 DreamLandMeta;                             // @0x345500 size 0x5c0, align 8
};
...
struct GSaveNpcVillager {                           /* 0x1e2158 big, align 8 */
  ...
  u8 gap_1e2147[1];
  GSaveItemName                      BirthdayPlantFtr[2];                       // @0x1e2148 size 0x8, align 4
};
...
struct GSaveLand {                                  /* 0x5279a0 big, align 16 */
  GSaveNpc                           Npc;                                       // @0x0 size 0x1e2170, align 16
  s_7b602b39                         _d35a9251;                                 // @0x1e2170 size 0x10, align 16
  GSavePlayerVillagerAccountTable    PlayerVillagerAccountTable;                // @0x1e2180 size 0x240, align 8
  GSaveWeather                       Weather;                                   // @0x1e23c0 size 0x14c, align 4
  u8 gap_1e250c[4];
  GSaveLandTime                      LandTime;                                  // @0x1e2510 size 0xe0, align 8
  GSaveLandId                        LandId;                                    // @0x1e25f0 size 0x1c, align 4
  u8 gap_1e260c[4];
  GSaveLandMyDesign                  LandMyDesign;                              // @0x1e2610 size 0x4b3a8, align 8
  GSaveEventFlagLand                 EventFlag;                                 // @0x22d9b8 size 0x800, align 2
  GSaveMainField                     MainField;                                 // @0x22e1b8 size 0xdaa2c, align 4
  GSavePlayerHouseList               PlayerHouseList;                           // @0x308be4 size 0x132000, align 4
  GSaveNpcHouseList                  NpcHouseList;                              // @0x43abe4 size 0x1248, align 4
  GSaveShop                          Shop;                                      // @0x43be2c size 0x33b4, align 4
  GSaveMuseum                        Museum;                                    // @0x43f1e0 size 0x3404, align 4
  GSaveVisitorNpc                    VisitorNpc;                                // @0x4425e4 size 0x78, align 4
  GSaveObjectSnowManFamily           SnowManFamily;                             // @0x44265c size 0x1b8, align 4
  GSaveFg                            Fg;                                        // @0x442814 size 0x928, align 4
  GSaveItemMarketingRoute            ItemMarketingRoute;                        // @0x44313c size 0x2, align 1
  u8 gap_44313e[2];
  GSaveVillageMelody                 VillageMelody;                             // @0x443140 size 0x10, align 8
  GSaveOffice                        Office;                                    // @0x443150 size 0x4, align 4
  u8 gap_443154[4];
  GSaveBulletinBoard                 BulletinBoard;                             // @0x443158 size 0xe0ae8, align 8
  s_b0fdefc8                         RegionLanguage;                            // @0x523c40 size 0x4, align 4
  s_75befa81                         CalendarEventRegion;                       // @0x523c44 size 0x4, align 4
  GSaveCampSite                      CampSite;                                  // @0x523c48 size 0x4, align 4
  GSaveNpcCamp                       NpcCamp;                                   // @0x523c4c size 0x114, align 4
  u8                                 AirportThemeColor;                         // @0x523d60 size 0x1, align 1
  u8 gap_523d61[1];
  GSaveRumorFavorite                 RumorFavorite;                             // @0x523d62 size 0x2520, align 2
  u8 gap_526282[2];
  GSaveMoney                         PublicWorksLoan;                           // @0x526284 size 0x8, align 4
  GSaveItemName                      PublicWorksName;                           // @0x52628c size 0x8, align 4
  GSaveVillageScore                  VillageScore;                              // @0x526294 size 0x250, align 4
  u8 gap_5264e4[4];
  GSaveNetLandProfile                NetLandProfile;                            // @0x5264e8 size 0x58, align 8
  GSaveEventFlagLandTemp             EventFlagTemp;                             // @0x526540 size 0x100, align 2
  GSaveMyDesignFireworks             MyDesignFireworks;                         // @0x526640 size 0x14, align 2
  GSaveSettlerQuest                  SettlerQuest;                              // @0x526654 size 0xc0, align 4
  u8                                 _5d1fcb04[4742];                           // @0x526714 size 0x1, align 1
};
...
struct GSaveShop {                                  /* 0x33b4 big, align 4 */
...
struct GSaveMain {                                  /* 0x86d570 big, align 16 */
  GSaveVersion                       Version;                                   // @0x0 size 0x100, align 4
  u8                                 _5d1fcb04[8];                              // @0x100 size 0x1, align 1
  u8 gap_108[8];
  GSaveLand                          Land;                                      // @0x110 size 0x5279a0, align 16
  GSaveLandOther                     LandOther;                                 // @0x527ab0 size 0x345ac0, align 16
};
...
struct GSaveNpc {                                   /* 0x1e2170 big, align 16 */
  s_7b602b39                         _d35a9251;                                 // @0x0 size 0x10, align 16
  GSaveNpcVillager                   NpcVillager;                               // @0x10 size 0x1e2158, align 8
};
