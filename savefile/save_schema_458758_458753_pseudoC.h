...
struct GSavePlayerOther {                          /* 0x402a0 big, align 16 */
  ...
  u8 gap_b184[4];
  GSaveMailUserInfo                 MailUserInfo;                           // @0xb188 size 0x13418, align 8
  GSaveDate                         _b58743fe;                              // @0x1e5a0 size 0x4, align 2
  GSaveDate                         _a4e58b58;                              // @0x1e5a4 size 0x4, align 2
  GSavePostingReserveList           PostingReserveList;                     // @0x1e5a8 size 0xb6b0, align 4
  s_ac6c2327                        _69144a57;                              // @0x29c58 size 0x8c, align 4
  s_75f0022c                        _f209c449;                              // @0x29ce4 size 0x10, align 4
  u8 gap_29cf4[4];
  GSaveFriendList                   FriendList;                             // @0x29cf8 size 0xb548, align 8
  GSaveSetting                      Setting;                                // @0x35240 size 0x1, align 1
  u8 gap_35241[3];
  GSaveMoney                        Savings;                                // @0x35244 size 0x8, align 4
  GSaveMoney                        BoxSell;                                // @0x3524c size 0x8, align 4
  GSaveCraftingRecipeCollect        CraftingRecipeCollect;                  // @0x35254 size 0x1400, align 2
  GSaveDate                         MoveOutBoxMoney;                        // @0x36654 size 0x4, align 2
  GSaveNetPlayerID                  NetPlayerID;                            // @0x36658 size 0x58, align 8
  GSaveNetMailBox                   NetMailBox;                             // @0x366b0 size 0x660, align 8
  GSavePlayerVisitorNpc             VisitorInfo;                            // @0x36d10 size 0x90, align 8
  GSaveAudioRegister                AudioRegister;                          // @0x36da0 size 0x20, align 4
  s_79d059af                        RegionLanguageID;                       // @0x36dc0 size 0x4, align 4
  u8 gap_36dc4[4];
  GSavePersonalPlayReportInfo       PlayReportInfo;                         // @0x36dc8 size 0xd10, align 8
  GSaveFishCollection               FishCollection;                         // @0x37ad8 size 0xd6, align 2
  GSaveInsectCollection             InsectCollection;                       // @0x37bae size 0xd6, align 2
  GSaveDiveFishCollection           DiveFishCollection;                     // @0x37c84 size 0x82, align 2
  u8 gap_37d06[2];
  s_2c3a15dc                        ReceivedAoC;                            // @0x37d08 size 0x104, align 4
  s_b16331d2                        ReceivedBCAT;                           // @0x37e0c size 0x204, align 4
  GSaveMoney                        KabuBuy;                                // @0x38010 size 0x8, align 4
  GSaveMoney                        KabuSell;                               // @0x38018 size 0x8, align 4
  GSaveAmiibo                       Amiibo;                                 // @0x38020 size 0xa0, align 4
  GSaveRemakeCommonPattern          RemakeCommonPattern;                    // @0x380c0 size 0x10, align 1
  GSaveMoney                        BoxTransfer;                            // @0x380d0 size 0x8, align 4
  u32                               _075e237a;                              // @0x380d8 size 0x4, align 4
  GSaveClockTimeList                ClockTimeList;                          // @0x380dc size 0x180, align 1
  GSaveHashList                     HashList;                               // @0x3825c size 0x40, align 4
  GSaveEventFlagPlayerTemp          EventFlagPlayerTemp;                    // @0x3829c size 0x100, align 2
  GSaveEventFlagPlayerVisit         EventFlagPlayerVisit;                   // @0x3839c size 0x100, align 2
  nn::util::Uuid                    DeviceId;                               // @0x3849c size 0x10, align 1
  GSaveMailUserLog                  MailUserLog;                            // @0x384ac size 0x14, align 2
  GSaveDate                         _bbfb1a0c;                              // @0x384c0 size 0x4, align 2
  GSaveMoney                        FoxTotalBuy;                            // @0x384c4 size 0x8, align 4
  u8 gap_384cc[4];
  s_e339850a                        _8c1a8bc8;                              // @0x384d0 size 0x6270, align 8
  s_32ab2180                        _28c68816;                              // @0x3e740 size 0x11f8, align 8
  s_29847e58                        _4bb54334;                              // @0x3f938 size 0x320, align 8
  s_a6478d46                        _340be62e;                              // @0x3fc58 size 0x644, align 4
};
...
struct GSaveLifeSupport {                          /* 0x62ac big, align 4 */
  ...
  bool                              _5d815ce6[512][6];                      // @0x56ac size 0x1, align 1
};
struct s_32ab2180 {                                /* 0x11f8 big, align 8 */
  s_e6b6a50f                        _d5ae5831;                              // @0x0 size 0x11f8, align 8
};
...
struct GSavePersonal {                             /* 0x76cf0 big, align 16 */
  ...
  GSavePlayerOther                  PlayerOther;                            // @0x36a50 size 0x402a0, align 16
};
...
struct s_644b78fd {                                /* 0x58 big, align 8 */
...
struct s_a6478d46 {                                /* 0x644 big, align 4 */
  GSaveItemName                     _199aa719[100];                         // @0x0 size 0x8, align 4
  GSaveTime                         _638daa62[100];                         // @0x320 size 0x8, align 2
  s32                               _8b03f93a;                              // @0x640 size 0x4, align 4
};
...
struct s_e339850a {                                /* 0x6270 big, align 8 */
  s_17100e6f                        _8c1a8bc8;                              // @0x0 size 0x6270, align 8
};
...
struct s_e6b6a50f {                                /* 0x11f8 big, align 8 */
  s_644b78fd                        Buffer[50];                             // @0x0 size 0x58, align 8
...
struct GSaveLandOther {                            /* 0x61f630 big, align 16 */
  GSavePersonal                     GuestPlayers[8];                        // @0x0 size 0x76cf0, align 16
  s_7b602b39                        _d35a9251;                              // @0x3b6780 size 0x10, align 16
  GSaveFgOther                      Fg;                                     // @0x3b6790 size 0x3fc, align 4
  u8 gap_3b6b8c[4];
  GSavePostStock                    PostStock;                              // @0x3b6b90 size 0x2633d0, align 8
  GSaveShopOther                    ShopOther;                              // @0x619f60 size 0xc, align 4
  u8 gap_619f6c[4];
  GSaveLandPlayReportInfo           PlayReportInfo;                         // @0x619f70 size 0x480, align 8
  GSaveDebugLog                     DebugLog;                               // @0x61a3f0 size 0x100, align 8
  GSaveLostItemBox                  LostItemBox;                            // @0x61a4f0 size 0x280, align 4
  GSaveNetLandID                    NetLandID;                              // @0x61a770 size 0x80, align 8
  GSavePlayerActivity               CurrentPlayerActivity[8];               // @0x61a7f0 size 0xd8, align 8
  GSavePlayerActivity               PreviousPlayerActivity[8];              // @0x61aeb0 size 0xd8, align 8
  GSavePlayerActivityPack           VisitorPlayerActivityPack[8];           // @0x61b570 size 0x6c0, align 8
  GSaveMyDesignHolderList           MyDesignHolderList;                     // @0x61eb70 size 0x64, align 1
  GSaveLandHashValue                GrowUpRandomFactor;                     // @0x61ebd4 size 0x4, align 4
  GSaveWeather                      TourWeather;                            // @0x61ebd8 size 0x14c, align 4
  GSaveMyDesignListOrder            MyDesignListOrder;                      // @0x61ed24 size 0x64, align 1
  GSaveTime                         LastSaveTime;                           // @0x61ed88 size 0x8, align 2
  s32                               MoveKitPlayer;                          // @0x61ed90 size 0x4, align 4
  s32                               MoveKitNpc;                             // @0x61ed94 size 0x4, align 4
  GSaveHashList                     HashList;                               // @0x61ed98 size 0x40, align 4
  GSaveNetworkEventData             EventData;                              // @0x61edd8 size 0x280, align 4
  GSaveBackupService                BackupService;                          // @0x61f058 size 0x10, align 8
  GSaveDreamLandMeta                _fdf027f9;                              // @0x61f068 size 0x5c0, align 8
};
...
struct GSaveShopTailor {                           /* 0x133c big, align 4 */
...
struct GSaveLand {                                 /* 0x5061a0 big, align 16 */
  ...
  GSaveLandStamp                    LandStamp;                              // @0x20a408 size 0x2003, align 1
  u8 gap_20c40b[1];
  GSaveEventFlagLand                EventFlag;                              // @0x20c40c size 0x800, align 2
  GSaveMainField                    MainField;                              // @0x20cc0c size 0xdaa2c, align 4
  GSavePlayerHouseList              PlayerHouseList;                        // @0x2e7638 size 0x132000, align 4
  GSaveNpcHouseList                 NpcHouseList;                           // @0x419638 size 0x1248, align 4
  GSaveShop                         Shop;                                   // @0x41a880 size 0x3154, align 4
  GSaveMuseum                       Museum;                                 // @0x41d9d4 size 0x3404, align 4
  GSaveVisitorNpc                   VisitorNpc;                             // @0x420dd8 size 0x78, align 4
  GSaveObjectSnowManFamily          SnowManFamily;                          // @0x420e50 size 0x1b8, align 4
  GSaveFg                           Fg;                                     // @0x421008 size 0x928, align 4
  GSaveItemMarketingRoute           ItemMarketingRoute;                     // @0x421930 size 0x2, align 1
  u8 gap_421932[6];
  GSaveVillageMelody                VillageMelody;                          // @0x421938 size 0x10, align 8
  GSaveOffice                       Office;                                 // @0x421948 size 0x4, align 4
  u8 gap_42194c[4];
  GSaveBulletinBoard                BulletinBoard;                          // @0x421950 size 0xe0ae8, align 8
  s_b0fdefc8                        RegionLanguage;                         // @0x502438 size 0x4, align 4
  s_75befa81                        CalendarEventRegion;                    // @0x50243c size 0x4, align 4
  GSaveCampSite                     CampSite;                               // @0x502440 size 0x4, align 4
  GSaveNpcCamp                      NpcCamp;                                // @0x502444 size 0x114, align 4
  u8                                AirportThemeColor;                      // @0x502558 size 0x1, align 1
  u8 gap_502559[1];
  GSaveRumorFavorite                RumorFavorite;                          // @0x50255a size 0x2520, align 2
  u8 gap_504a7a[2];
  GSaveMoney                        PublicWorksLoan;                        // @0x504a7c size 0x8, align 4
  GSaveItemName                     PublicWorksName;                        // @0x504a84 size 0x8, align 4
  GSaveVillageScore                 VillageScore;                           // @0x504a8c size 0x250, align 4
  u8 gap_504cdc[4];
  GSaveNetLandProfile               NetLandProfile;                         // @0x504ce0 size 0x58, align 8
  GSaveEventFlagLandTemp            EventFlagTemp;                          // @0x504d38 size 0x100, align 2
  GSaveMyDesignFireworks            MyDesignFireworks;                      // @0x504e38 size 0x14, align 2
  GSaveSettlerQuest                 SettlerQuest;                           // @0x504e4c size 0xc0, align 4
  u8                                _5d1fcb04[4742];                        // @0x504f0c size 0x1, align 1
};
...
struct GSaveShopZakka {                            /* 0x1768 big, align 4 */
...
struct GSaveShop {                                 /* 0x3154 big, align 4 */
  s_9e242739                        ShopLevel;                              // @0x0 size 0x4, align 4
  GSaveShopCarpet                   ShopCarpet;                             // @0x4 size 0x28, align 4
  GSaveShopTailor                   ShopTailor;                             // @0x2c size 0x133c, align 4
  GSaveShopShoes                    ShopShoes;                              // @0x1368 size 0x110, align 4
  GSaveShopZakka                    ShopZakka;                              // @0x1478 size 0x1768, align 4
  GSaveShopKabu                     ShopKabu;                               // @0x2be0 size 0x44, align 4
  GSaveShopCatalog                  ShopCatalog;                            // @0x2c24 size 0x200, align 4
  u8                                HatPattern;                             // @0x2e24 size 0x1, align 1
  u8 gap_2e25[3];
  GSaveItemName                     PointExchangeItem[16];                  // @0x2e28 size 0x8, align 4
  GSaveShopGardening                ShopGardening;                          // @0x2ea8 size 0x100, align 4
  GSaveShopGallery                  ShopGallery;                            // @0x2fa8 size 0x1ac, align 4
};
...
struct GSaveMain {                                 /* 0xb258e0 big, align 16 */
  GSaveVersion                      Version;                                // @0x0 size 0x100, align 4
  u8                                _5d1fcb04[8];                           // @0x100 size 0x1, align 1
  u8 gap_108[8];
  GSaveLand                         Land;                                   // @0x110 size 0x5061a0, align 16
  GSaveLandOther                    LandOther;                              // @0x5062b0 size 0x61f630, align 16
};
...
struct GSaveNetLandProfile {                       /* 0x58 big, align 8 */
  ...
  _a8d2a4d4                         _0aa6228b;                              // @0x38 size 0x8, align 8
